...
// AppEUI (LSB)
static const u1_t PROGMEM APPEUI[8] = { 0x11,0x22,0x33,0x44,0x55,0x66,0x77,0x01 };
// DevEUI (LSB)
static const u1_t PROGMEM DEVEUI[8] = { 0xDE,0xAD,0xBE,0xEF,0x01,0x02,0x03,0x01 };
// AppKey (MSB)
static const u1_t PROGMEM APPKEY[16] = { 0x2D,0x1F,0x93,0x57,0x42,0x7B,0xA0,0x03,0x2E,0xAE,0x48,0x76,0xF1,0xC2,0x9B,0x01 };
...
void setup() {
    ...
    delay(1000);
    Serial.println("Starting Makerfabs Soil Sensor Node - Device 1");
